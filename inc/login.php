                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Bienvenido a Control de Inventario</h1>
                                </div>
                                <form class="user">
                                    <div class="form-group">
                                        <input type="text" id="usuario" class="form-control form-control-user"
                                              aria-describedby="emailHelp"
                                               placeholder="Ingrese su Usuario..." required>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user"
                                               id="palabra_secreta" placeholder="Contraseña">
                                    </div>

                                    <a id="iniciar_sesion" class="btn btn-primary btn-user btn-block">
                                        Ingresar
                                    </a>
